		...
		<section className="tc pa3 pa5-ns" >
			<article className="hide-child relative ba b--black-20 mw5 center">
				<div className="pa2 bt b--black-20">
					...
					<button className="link tc ph3 pv1 db bg-animate bg-dark-blue hover-bg-blue white f6 br1">Edit</button>
				</div>
				<button className="child absolute top-1 right-1 ba bw1 black-40 grow no-underline br-100 w1 h1 pa2 lh-solid b" >×</button>
			</article>
		</section>
